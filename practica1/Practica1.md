...
Los lenguajes que dominan la industria del software son imperativos, como Java, Python o C#, los cuales ejecutan secuencias de instrucciones
y en los que el estado de las declaraciones puede cambiar, por ejemplo, al modificar las variables.

Haskell se diferencia por ser un lenguaje funcional. En Haskell, una variable tiene un valor permanente que no puede 
cambiarse con facilidad. Las funciones se utilizan para calcular y devolver el resultado correspondiente.

Este tipo de diferencias hace que el uso que se les da a los lenguajes sea distinto: los primeros se emplean en el desarrollo
de aplicaciones empresariales, móviles y web, mientras que Haskell se utiliza en mayor medida en aplicaciones científicas y matemáticas.
De esta forma, se reduce el número de personas que lo utilizarían y, a su vez, disminuye la inversión en este lenguaje.

4.- Si pudieras realizar un simple analogía entre Git y GitHub. ¿Cuál se te vendría a la mente?

Git es mi tarea con sus diferentes versiones (versión 1, versión 1.1 y versión final), donde guardo y reviso cada cambio que hice.
...
Escobar, G. (2017, November 6). Lenguajes compilados e interpretados. El Blog de Make it Real. https://blog.makeitreal.camp/lenguajes-compilados-e-interpretados/

Haskell: el lenguaje de programación funcional. (2020, October 9). IONOS Digital Guide. https://www.ionos.mx/digitalguide/paginas-web/desarrollo-web/que-es-haskell/

Swetha. (2023, April 28). Java vs. Haskell: Understanding the key differences. Medium. https://blog.devgenius.io/java-vs-haskell-understanding-the-key-differences-5b6b777c577e

Tema 2: Introducción a la programación con Haskell. (n.d.). Cs.Us.Es. Retrieved February 17, 2026, from https://www.cs.us.es/~jalonso/cursos/i1m/temas/tema-2.html
